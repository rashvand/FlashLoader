...
////////////////////////////////////////////////////////////////////////////////
/*----------------------------------------------------------------------------*/
//丝印25Q64JVSIQ，参考官方文档W25Q64JV_DTR
//1 Sector = 4kB, 1 Block = 16 Sectors, 128 Blocks = 2048 Sectors = 8MB

//注意：W25Q256支持4字节地址模式
//W25X_SectorErase、W25X_FastReadData和W25X_PageProgram 3个命令需改为32位地址模式

u16 W25QXX_TYPE = W25Q256; //默认是W25Q64
